...
# Read the CSV files
data1 = pd.read_csv('0852_G3.csv')
data2 = pd.read_csv('0926_G3.csv')
data3 = pd.read_csv('1000_G3.csv')
data4 = pd.read_csv('1074_G3.csv')
data5 = pd.read_csv('G3_Clean.csv')
...
plt.figure(1)
plt.plot([x/100 - 1.28 for x in flow_time5], tip_displacement5, color='magenta')
plt.plot([x/100 - 1.28 for x in flow_time1], tip_displacement1, color='black')
plt.plot([x/100 - 1.28 for x in flow_time2], tip_displacement2, color='blue')
plt.plot([x/100 - 1.28 for x in flow_time3], tip_displacement3, color='red')
plt.plot([x/100 - 1.28 for x in flow_time4], tip_displacement4, color='green')
...
plt.legend(['Clean Wing ', 'DTR = -1.09 ', 'DTR = -0.04 ', 'DTR = 1.00 ','DTR = 1.56 '], fontsize = 16)
plt.xlabel('Time (s)', fontsize = 18)
plt.ylabel('Tip Displacement', fontsize = 18)
# plt.title('Tip Displacement Vs Time (Deployment Time Variation (s)) Gust G3')
plt.grid(True)
...
plt.figure(2)
plt.plot([x/100 - 1.28 for x in flow_time5], lift_coeff5, color='magenta')
plt.plot([x/100 - 1.28 for x in flow_time1], lift_coeff1, color='black')
plt.plot([x/100 - 1.28 for x in flow_time2], lift_coeff2, color='blue')
plt.plot([x/100 - 1.28 for x in flow_time3], lift_coeff3, color='red')
plt.plot([x/100 - 1.28 for x in flow_time4], lift_coeff4, color='green')


plt.axvline(x=0, color='black', linestyle='--', linewidth=1)  # Peak Cl
plt.text(12 + 1, 0.5, f'Max Diff: {percentage_difference:.3f}%', color='black', fontsize = 16)
...
# plt.title('Lift Coeff. Vs Time (Deployment Time Variation (s)) Gust G3')
plt.grid()
...
lift_coeff_at_4 = [lift_coeff1[138], lift_coeff2[138], lift_coeff3[138], lift_coeff4[138]]
...
plt.xticks(configurations, ['-1.09', '-0.04', '1.00', '1.56'])
